    ...
    for bullet in earth_bullets:
        ...
        for ship in big_ship:
            if bullet.colliderect(ship):
                ...
                earth_bullets.remove(bullet)
                for big_bul in big_ship_bullets:
                    big_ship_bullets.remove(big_bul)
...
def main():
    global select_ship
    earth_spaceship = pygame.Rect(300, 600, SPACESHIP_WIDTH, SPACESHIP_HEIGHT)
